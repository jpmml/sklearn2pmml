...
class ContinuousDomainTest(TestCase):
	...
	def test_fit_float(self):
		...
		self.assertFalse(hasattr(domain, "data_1st_quantile_"))
		self.assertFalse(hasattr(domain, "data_3rd_quantile_"))
		self.assertFalse(hasattr(domain, "data_total_freq_"))
		self.assertFalse(hasattr(domain, "data_missing_freq_"))
		...
		self.assertEqual(1.75, domain.data_1st_quantile_)
		self.assertEqual(2.25, domain.data_3rd_quantile_)
		self.assertEqual(6, domain.data_total_freq_)
		self.assertEqual(2, domain.data_missing_freq_)
	...
	def test_mapper(self):
		...
		self.assertEqual(numpy.array([1.5, 1.25]).tolist(), domain.data_1st_quantile_.tolist())
		self.assertEqual(numpy.array([2.5, 2.75]).tolist(), domain.data_3rd_quantile_.tolist())
