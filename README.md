...
The current version is **0.116.0** (18 March, 2025):

```
pip install sklearn2pmml==0.116.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01160) file.
