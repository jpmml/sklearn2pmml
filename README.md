...
The current version is **0.119.1** (20 June, 2025):

```
pip install sklearn2pmml==0.119.1
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01191) file.
