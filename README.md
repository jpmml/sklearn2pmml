...
The current version is **0.124.0** (6 December, 2025):

```
pip install sklearn2pmml==0.124.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01240) file.
