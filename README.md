...
The current version is **0.127.0** (23 January, 2026):

```
pip install sklearn2pmml==0.127.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01270) file.
