...
The current version is **0.123.0** (28 September, 2025):

```
pip install sklearn2pmml==0.123.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#0123.0) file.
