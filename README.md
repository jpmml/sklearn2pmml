...
The current version is **0.118.0** (9 June, 2025):

```
pip install sklearn2pmml==0.118.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01180) file.
