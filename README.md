...
The current version is **0.114.0** (9 March, 2025):

```
pip install sklearn2pmml==0.114.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01140) file.
