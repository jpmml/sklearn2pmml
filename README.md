...
The current version is **0.129.0** (9 March, 2026):

```
pip install sklearn2pmml==0.129.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01290) file.
