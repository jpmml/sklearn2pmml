...
The current version is **0.116.2** (2 April, 2025):

```
pip install sklearn2pmml==0.116.2
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01162) file.
