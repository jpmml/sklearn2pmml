...
The current version is **0.121.1** (4 August, 2025):

```
pip install sklearn2pmml==0.121.1
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01211) file.
