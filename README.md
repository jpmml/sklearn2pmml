...
The current version is **0.116.1** (30 March, 2025):

```
pip install sklearn2pmml==0.116.1
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01161) file.
