...
The current version is **0.133.1** (30 August, 2026):

```
pip install sklearn2pmml==0.133.1
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01331) file.
