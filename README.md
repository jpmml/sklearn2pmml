...
The current version is **0.121.0** (30 June, 2025):

```
pip install sklearn2pmml==0.121.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01210) file.
