...
The current version is **0.119.0** (15 June, 2025):

```
pip install sklearn2pmml==0.119.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01190) file.
