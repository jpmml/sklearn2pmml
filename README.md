...
The current version is **0.127.2** (5 February, 2026):

```
pip install sklearn2pmml==0.127.2
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01272) file.
