...
The current version is **0.126.0** (15 January, 2026):

```
pip install sklearn2pmml==0.126.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01260) file.
