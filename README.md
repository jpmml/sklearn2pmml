...
The current version is **0.128.1** (27 February, 2026):

```
pip install sklearn2pmml==0.128.1
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01281) file.
