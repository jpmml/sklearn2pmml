...
The current version is **0.131.0** (16 June, 2026):

```
pip install sklearn2pmml==0.131.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01310) file.
