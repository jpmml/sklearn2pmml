...
The current version is **0.120.0** (26 June, 2025):

```
pip install sklearn2pmml==0.120.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01200) file.
