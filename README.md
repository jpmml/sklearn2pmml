...
The current version is **0.130.0** (4 April, 2026):

```
pip install sklearn2pmml==0.130.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01300) file.
