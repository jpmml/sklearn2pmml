...
The current version is **0.107.0** (25 April, 2024):

```
pip install sklearn2pmml==0.107.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01070) file.
