...
The current version is **0.126.1** (20 January, 2026):

```
pip install sklearn2pmml==0.126.1
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01261) file.
