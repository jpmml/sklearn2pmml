...
The current version is **0.122.0** (2 September, 2025):

```
pip install sklearn2pmml==0.122.0
```

See the [NEWS.md](https://github.com/jpmml/sklearn2pmml/blob/master/NEWS.md#01220) file.
